...
class WalkingExpDA:
    ...
    def initialize_log(self):
        ...
        with open(self.log_file, 'a') as fp:
            writer = csv.writer(fp, delimiter = '\t')
#           Should be like this? with ss/ll headers instead of left/right?
#            writer.writerow(['subj_id', 'trial_no', 'is_staircase', 'ss_delay', 'ss_amount', 
#                   'll_delay', 'll_amount', 'is_ss_on_left', 'response', 
#                   'RT', 'start_time'])
